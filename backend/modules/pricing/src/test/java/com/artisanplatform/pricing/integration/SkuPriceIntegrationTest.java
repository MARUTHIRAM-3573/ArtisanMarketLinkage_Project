package com.artisanplatform.pricing.integration;
...
/**
 * Full round-trip test for SkuPrice: HTTP request -> service -> PostgreSQL
...
class SkuPriceIntegrationTest extends BaseIntegrationTest {
    ...
    void fullRoundTrip_createThenGet_returnsPersistedEntity() {
        // TODO: once SkuPriceController's create/get methods are implemented,
        // POST a valid SkuPriceRequest, assert 2xx, then GET the created
