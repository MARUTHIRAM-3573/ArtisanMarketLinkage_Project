package com.artisanplatform.ai.integration;
...
/**
 * Full round-trip test for AiJob: HTTP request -> service -> PostgreSQL
...
class AiJobIntegrationTest extends BaseIntegrationTest {
    ...
    void fullRoundTrip_createThenGet_returnsPersistedEntity() {
        // TODO: once AiJobController's create/get methods are implemented,
        // POST a valid AiJobRequest, assert 2xx, then GET the created
