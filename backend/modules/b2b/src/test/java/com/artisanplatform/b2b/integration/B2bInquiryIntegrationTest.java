package com.artisanplatform.b2b.integration;
...
/**
 * Full round-trip test for B2bInquiry: HTTP request -> service -> PostgreSQL
...
class B2bInquiryIntegrationTest extends BaseIntegrationTest {
    ...
    void fullRoundTrip_createThenGet_returnsPersistedEntity() {
        // TODO: once B2bInquiryController's create/get methods are implemented,
        // POST a valid B2bInquiryRequest, assert 2xx, then GET the created
