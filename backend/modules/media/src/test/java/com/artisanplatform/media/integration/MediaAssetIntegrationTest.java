package com.artisanplatform.media.integration;
...
/**
 * Full round-trip test for MediaAsset: HTTP request -> service -> PostgreSQL
...
class MediaAssetIntegrationTest extends BaseIntegrationTest {
    ...
    void fullRoundTrip_createThenGet_returnsPersistedEntity() {
        // TODO: once MediaAssetController's create/get methods are implemented,
        // POST a valid MediaAssetRequest, assert 2xx, then GET the created
