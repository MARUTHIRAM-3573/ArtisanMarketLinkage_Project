package com.artisanplatform.media.unit.controller;

import com.artisanplatform.media.controller.MediaAssetController;
...
/**
 * Controller-slice test for MediaAssetController. Add one @Test per endpoint
 ...
 */
@WebMvcTest(controllers = MediaAssetController.class)
class MediaAssetControllerTest {
    ...
    void contextLoads() {
        ...
        // UnsupportedOperationException — see MediaAssetController).
    }
}
