package com.artisanplatform.catalog.integration;
...
/**
 * Full round-trip test for Product: HTTP request -> service -> PostgreSQL
...
class ProductIntegrationTest extends BaseIntegrationTest {
    ...
    void fullRoundTrip_createThenGet_returnsPersistedEntity() {
        // TODO: once ProductController's create/get methods are implemented,
        // POST a valid ProductRequest, assert 2xx, then GET the created
