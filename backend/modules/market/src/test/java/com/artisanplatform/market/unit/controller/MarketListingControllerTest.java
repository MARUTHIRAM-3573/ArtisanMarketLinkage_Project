package com.artisanplatform.market.unit.controller;

import com.artisanplatform.market.controller.MarketListingController;
...
/**
 * Controller-slice test for MarketListingController. Add one @Test per endpoint
 ...
 */
@WebMvcTest(controllers = MarketListingController.class)
class MarketListingControllerTest {
    ...
    void contextLoads() {
        ...
        // UnsupportedOperationException — see MarketListingController).
    }
}
