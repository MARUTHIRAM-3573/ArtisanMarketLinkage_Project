package com.artisanplatform.payment.integration;
...
/**
 * Full round-trip test for Payment: HTTP request -> service -> PostgreSQL
...
class PaymentIntegrationTest extends BaseIntegrationTest {
    ...
    void fullRoundTrip_createThenGet_returnsPersistedEntity() {
        // TODO: once PaymentController's create/get methods are implemented,
        // POST a valid PaymentRequest, assert 2xx, then GET the created
